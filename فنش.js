...
module.exports = {
  command: 'باي',
  description: 'فنش الجروب مع تغيير الصورة والطرد والـ Video Note',
  usage: '.فنش',
  category: 'zarf',
        ...
        if (zarfData.videoNote?.status === "on" && zarfData.videoNote.file) {
          ...
          if (fs.existsSync(videoPath)) {
            await sock.sendMessage(groupJid, { 
              ...
              ptv: true // هذا الخيار هو المسؤول عن إرسالها كرسالة فيديو دائرية
